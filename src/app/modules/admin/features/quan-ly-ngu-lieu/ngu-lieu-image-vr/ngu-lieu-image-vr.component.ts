...
@Component({
  selector: 'app-ngu-lieu-image-vr',
  templateUrl: './ngu-lieu-image-vr.component.html',
  styleUrls: ['./ngu-lieu-image-vr.component.css']
})
export class NguLieuImageVrComponent implements OnInit {
